...
COMPANY = {
    "rms_name":    "April Leslie",
    "rms_license": "#17SS065",
    "rms_name_2":    "Chase Coltrain",
    "rms_license_2": "#26MS015",
    "website":     "RVAradon.com",
    "logo_path":   "assets/rva_logo.jpg",
    # Fallback phone used when raw PDF doesn't include one in its header.
    # The newer SunRADON format omits phone from the page-1 header.
    "company_phone": "(804) 385-2233",
}
